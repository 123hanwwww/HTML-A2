...
function getFormData() {
    return {
        ...
        supplierName: document.getElementById("supplier").value.trim(),
...
function updateItemByName(itemName, updatedData) {
    if (!itemName) {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    updateBtn.addEventListener("click", () => {
        ...
        if (formData.itemId)
            updatedData.itemId = formData.itemId;
        if (formData.itemName)
            updatedData.itemName = formData.itemName;
        if (formData.category)
            updatedData.category = formData.category;
        if (formData.quantity > 0)
            updatedData.quantity = formData.quantity;
        if (formData.price > 0)
            updatedData.price = formData.price;
        if (formData.supplierName)
            updatedData.supplierName = formData.supplierName;
        if (formData.stockStatus)
            updatedData.stockStatus = formData.stockStatus;
        if (formData.popularItem)
            updatedData.popularItem = formData.popularItem;
